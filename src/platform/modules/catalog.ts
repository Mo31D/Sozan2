...
export const BUILTIN_MODULES = [
  ...
  },
  {
    ...
    version: 1,
    title: 'Planner',
    description: 'Shared planning surface that consumes schedule providers from enabled modules.',
    dependencies: [],
    defaultEnabled: true,
  ...
  },
  {
    ...
    version: 1,
    title: 'Reports',
    description: 'Derived reporting and deterministic insights.',
