...
export const WORKSPACE_TEMPLATES: readonly WorkspaceTemplate[] = [
  ...
  },
  {
    ...
    labels: {
      'entity.person.singular': 'عميل',
      'entity.person.plural': 'عملاء',
      'entity.activity.singular': 'موعد',
      'entity.activity.plural': 'مواعيد',
    },
  },
  {
    key: 'small_business',
    ...
    labels: {
      'entity.person.singular': 'عميل',
      'entity.person.plural': 'عملاء',
      'entity.activity.singular': 'مهمة',
      'entity.activity.plural': 'مهام',
    },
  },
  {
    key: 'custom',
