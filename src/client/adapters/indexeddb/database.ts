...
export const STORES = {
  ...
  tutoringBillingAccounts: 'tutoring_billing_accounts',
  tutoringBillingAccountMembers: 'tutoring_billing_account_members',
  tutoringBillingAccountCycles: 'tutoring_billing_account_cycles',
