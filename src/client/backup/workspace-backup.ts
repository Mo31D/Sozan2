...
const STORE_MAP = {
  ...
  tutoringBillingAccounts: STORES.tutoringBillingAccounts,
  tutoringBillingAccountMembers: STORES.tutoringBillingAccountMembers,
  tutoringBillingAccountCycles: STORES.tutoringBillingAccountCycles,
